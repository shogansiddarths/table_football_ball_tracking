...
while True:
    ...
    if field_ready:
            ...
            if prev_valid_ball is not None and (current_time - last_goal_time > goal_cooldown):
                ...
                if goal_axis == "y":
                    if py < top_goal_y <= wy:
                        ...
                        print("GOAL -> BLACK PLAYER")
 
                    elif py > bottom_goal_y >= wy:
                        top_player_goals += 1
                        goal_event = 1
                        last_goal_time = current_time
                        print("GOAL -> WHITE PLAYER")
        ...
        # SCORE DISPLAY
        cv2.putText(warped_debug, f"TOP: {top_player_goals}", (20, 40),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
 
        cv2.putText(warped_debug, f"BOTTOM: {bottom_player_goals}", (20, field_height - 20),
                    cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 255), 2)
 
        cv2.putText(warped_debug, f"GOAL AXIS: {goal_axis.upper()}",
